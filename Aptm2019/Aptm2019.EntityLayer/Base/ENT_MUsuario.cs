...
namespace Aptm2019.EntityLayer
{
	public class ENT_MUsuario
	{
        ...
        /// Initializes a new instance of the ENT_MUsuario class.
        /// </summary>
        public ENT_MUsuario(string MUSR_cUsuario, string MUSR_cPassword, bool MUSR_lActivo, int MUSR_nIdEmpleado)
        {
            this.MUSR_cUsuario = MUSR_cUsuario;
            this.MUSR_cPassword = MUSR_cPassword;
            this.MUSR_lActivo = MUSR_lActivo;
            this.MUSR_nIdEmpleado = MUSR_nIdEmpleado;
        }

        /// <summary>
        /// Initializes a new instance of the ENT_MUsuario class.
        /// </summary>
        public ENT_MUsuario(int MUSR_nId, string MUSR_cUsuario, string MUSR_cPassword, bool MUSR_lActivo, int MUSR_nIdEmpleado)
        {
        ...
        /// <summary>
        /// Gets or sets the MUSR_nIdEmpleado value. 
        /// </summary>
        public int MUSR_nIdEmpleado { get; set; }
