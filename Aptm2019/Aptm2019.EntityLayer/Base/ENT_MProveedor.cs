...
namespace Aptm2019.EntityLayer
{
	public class ENT_MProveedor
    {
        ...
        /// Initializes a new instance of the ENT_MProveedor class.
        /// </summary>
        public ENT_MProveedor(int MPROV_nTipoDoc, string MPROV_cDocumento, string MPROV_cNombre, string MPROV_cDireccion, string MPROV_cTelefono, bool MPROV_lActivo, int MPROV_nUsrReg, DateTime MPROV_dFechReg, int MPROV_nUsrMod, DateTime MPROV_dFechMod)
        {
            this.MPROV_nTipoDoc = MPROV_nTipoDoc;
            this.MPROV_cDocumento = MPROV_cDocumento;
        ...
        /// Initializes a new instance of the ENT_MProveedor class.
        /// </summary>
        public ENT_MProveedor(int MPROV_nId, int MPROV_nTipoDoc, string MPROV_cDocumento, string MPROV_cNombre, string MPROV_cDireccion, string MPROV_cTelefono, bool MPROV_lActivo, int MPROV_nUsrReg, DateTime MPROV_dFechReg, int MPROV_nUsrMod, DateTime MPROV_dFechMod)
        {
        ...
        /// <summary>
        /// Gets or sets the MPROV_cDocumento value. 
        /// </summary>
        public string MPROV_cDocumento { get; set; }
