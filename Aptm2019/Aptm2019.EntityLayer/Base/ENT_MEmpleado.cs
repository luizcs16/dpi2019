...
namespace Aptm2019.EntityLayer
{
	public class ENT_MEmpleado
	{
		...
		/// Initializes a new instance of the ENT_MEmpleado class.
		/// </summary>
		public ENT_MEmpleado(string MEMP_cNombre, string MEMP_cApePaterno, string MEMP_cApeMaterno, int MEMP_nTipoDoc, int MEMP_nDocumento, string MEMP_cDireccion, string MEMP_cTelefono, int MEMP_nIdMUsuario, bool MEMP_lActivo, int MEMP_nUsrReg, DateTime MEMP_dFechReg, int MEMP_nUsrMod, DateTime MEMP_dFechMod)
		{
			...
			this.MEMP_nIdMUsuario = MEMP_nIdMUsuario;
		...
		/// Initializes a new instance of the ENT_MEmpleado class.
		/// </summary>
		public ENT_MEmpleado(int MEMP_nId, string MEMP_cNombre, string MEMP_cApePaterno, string MEMP_cApeMaterno, int MEMP_nTipoDoc, int MEMP_nDocumento, string MEMP_cDireccion, string MEMP_cTelefono, int MEMP_nIdMUsuario, bool MEMP_lActivo, int MEMP_nUsrReg, DateTime MEMP_dFechReg, int MEMP_nUsrMod, DateTime MEMP_dFechMod)
		{
		...
		/// <summary>
		/// Gets or sets the MEMP_nIdMUsuario value. 
		/// </summary>
		public int MEMP_nIdMUsuario { get; set; }
